...
SECRET_KEY = 'b+ti3d(66f-ks=9d^d+gc93pnj$a56%j6gvhk%jz^a+n()g7&u'
...
PAGINATOR_BOX_ACTIVITIES = os.environ.get('PAGINATOR_BOX_ACTIVITIES','10')
PAGINATOR_BOX_ACTIVITIES = int(PAGINATOR_BOX_ACTIVITIES)
